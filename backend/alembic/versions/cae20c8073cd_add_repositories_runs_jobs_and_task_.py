...
Revision ID: cae20c8073cd
Revises: a8478c9539ea
Create Date: 2026-07-31 18:34:57.674160
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "paused", "deleting", name="repo_status", native_enum=False),
            nullable=False,
        ),
        sa.Column("last_polled_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("last_synced_run_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("runs_etag", sa.String(length=255), nullable=True),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
